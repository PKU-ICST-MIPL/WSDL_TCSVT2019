...
config.FIXED_PARAMS =  ['conv1', 'conv2', 'conv3', 'conv4', 'conv5','rpn', 'fc', 'bbox', 'cls', 'fixed']
config.FIXED_PARAMS_SHARED =  ['conv1', 'conv2', 'conv3', 'conv4', 'conv5','rpn', 'fc', 'bbox', 'cls']
...
# default network
default.network = 'vgg'
default.pretrained = 'model/e2e-conv5_3'
...
default.dataset_path = 'data/VOCdevkit2007'
# default training
default.frequent = 20
default.kvstore = 'device'
# default e2e
default.e2e_prefix = 'model/e2e-conv5_3/e2e'
default.e2e_epoch = 15
