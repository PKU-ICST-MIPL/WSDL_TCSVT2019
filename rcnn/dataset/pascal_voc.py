...
class PascalVOC(IMDB):
    def __init__(self, image_set, root_path, devkit_path):
        ...
        classes_f = open('/home/junchao/hexiangteng/mxnet/mx-rcnn-master-car-2/data/VOCdevkit2007/classes.txt')
        f_content = classes_f.read()
        rows = f_content.split('\n')
        self.classes.extend(rows)
	self.classes = self.classes[0:196]
    ...
    def load_pascal_annotation(self, index):
        ...
        for ix, obj in enumerate(objs):
            ...
            cls = class_to_index[obj.find('name').text.strip()]
