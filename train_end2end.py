...
def train_net(args, ctx, pretrained, epoch, prefix, begin_epoch, end_epoch,
    ...
    if args.resume:
        ...
        #arg_params['fixed_fc6_weight'] = mx.random.normal(0, 0.001, shape=arg_shape_dict['fixed_fc6_weight'])
        #arg_params['fixed_fc6_bias'] = mx.nd.zeros(shape=arg_shape_dict['fixed_fc6_bias'])
        #arg_params['fixed_fc7_weight'] = mx.random.normal(0, 0.001, shape=arg_shape_dict['fixed_fc7_weight'])
        #arg_params['fixed_fc7_bias'] = mx.nd.zeros(shape=arg_shape_dict['fixed_fc7_bias'])
        #arg_params['fixed_cls_score_weight'] = mx.random.normal(0, 0.01, shape=arg_shape_dict['fixed_cls_score_weight'])
        #arg_params['fixed_cls_score_bias'] = mx.nd.zeros(shape=arg_shape_dict['fixed_cls_score_bias'])
        #arg_params['fixed_bbox_pred_weight'] = mx.random.normal(0, 0.001, shape=arg_shape_dict['fixed_bbox_pred_weight'])
        #arg_params['fixed_bbox_pred_bias'] = mx.nd.zeros(shape=arg_shape_dict['fixed_bbox_pred_bias'])
        arg_params['dfixed_fc6_weight'] = mx.random.normal(0, 0.001, shape=arg_shape_dict['fixed_fc6_weight'])
        arg_params['dfixed_fc6_bias'] = mx.nd.zeros(shape=arg_shape_dict['fixed_fc6_bias'])
        arg_params['dfixed_fc7_weight'] = mx.random.normal(0, 0.001, shape=arg_shape_dict['fixed_fc7_weight'])
        arg_params['dfixed_fc7_bias'] = mx.nd.zeros(shape=arg_shape_dict['fixed_fc7_bias'])
        arg_params['dfixed_cls_score_weight'] = mx.random.normal(0, 0.01, shape=arg_shape_dict['fixed_cls_score_weight'])
        arg_params['dfixed_cls_score_bias'] = mx.nd.zeros(shape=arg_shape_dict['fixed_cls_score_bias'])
        arg_params['dfixed_bbox_pred_weight'] = mx.random.normal(0, 0.001, shape=arg_shape_dict['fixed_bbox_pred_weight'])
        arg_params['dfixed_bbox_pred_bias'] = mx.nd.zeros(shape=arg_shape_dict['fixed_bbox_pred_bias'])
